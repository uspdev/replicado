...
class Posgraduacao
{
   ...
   * @return array
   */
  public static function ativos($codundclg)
  {
    ...
    $query .= " WHERE LOCALIZAPESSOA.tipvin = 'ALUNOPOS' AND LOCALIZAPESSOA.codundclg IN (:codundclg) AND LOCALIZAPESSOA.sitatl = 'A'";
