...
namespace Uspdev\Replicado\Base;
...
class Estrutura
{
     ...
     */
    protected static function dump($codset)
    {
        $query = "SELECT s.*
                  FROM SETOR AS s 
     ...
     */
    protected static function listarSetores($codund = null)
    {
     ...
     * @author Fernando G. Moura <fgm@sc.sp.br>
     */
    protected static function getChefiaSetor($codset, $substitutos = true)
    {
        if ($substitutos) {
     ...
     */
    protected static function listarUnidades()
    {
     ...
     */
    protected static function obterUnidade($codund)
    {
     ...
     */
    protected static function obterLocal($codlocusp)
    {
     ...
     * @author Antonio Augusto de Campos, em 13/08/2025
     */
    protected static function listarLocaisUnidade($codund = null)
    {
     ...
     * @author Antonio Augusto de Campos, em 13/08/2025
     */
    protected static function procurarLocal($partCodlocusp, $codund = 0)
    {
        if ($codund === 0) {
